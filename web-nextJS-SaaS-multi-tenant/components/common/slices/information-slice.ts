...
const informationSlice = createSlice({
  ...
  reducers: {
    ...
    setWarnings(state: InformationState, action: PayloadAction<Record<string, string>>) {
...
export const { setSuccess, setWarnings, setError, clearInformations } = informationSlice.actions;
