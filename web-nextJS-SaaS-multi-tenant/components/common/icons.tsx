...
export const Logo: React.FC<IconSvgProps> = ({ size = 36, height, ...props }:{size?:number;height?: number}) => (
...
export const RemindersIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => {
  const finalsize = size ?? width ?? height;
  return (
    <svg height={size ?? height} viewBox="0 0 24 24" width={size ?? width} {...props} fill="none">
      <path
...
export const DeleteIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => {
  return (
    <svg
      focusable="false"
      height={size ?? height}
