...
const tasksSlice = createSlice({
  ...
  reducers: {
    ...
    addTask(
      _state: TasksState,
      _action: PayloadAction<{ createTask: CreateTask; params: string }>,
    ) {},
    editTask(_state: TasksState, _action: PayloadAction<{ id: number; formData: CreateTask }>) {},
    ...
    filterTasks(state: TasksState, _action: PayloadAction<string>) {
      state.loading = true;
    },
    importCSV(state: TasksState, _action: PayloadAction<{ file: File; params: string }>) {
      state.loading = true;
    },
    downloadCSV(_state: TasksState, _action: PayloadAction<{ params: string; pageNo: number }>) {},
