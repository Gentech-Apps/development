  ...
  return (
    <Modal isOpen={isOpen} placement="center" onOpenChange={onOpenChange}>
      <ModalContent>
        {(onClose) => (
          <>
            <ModalHeader className="flex flex-col gap-1">Import Tasks</ModalHeader>
            <ModalBody>
              <h3>Upload A CSV File with Fields...</h3>
              <p>
                Title*, description*, Status(Todo, In_progress, Completed), Priority ( Low, Medium,
                High), Startdatetime, Deadline, Reminder
              </p>
              <Input isRequired accept="text/csv" type="file" onChange={handleFileChange} />
            </ModalBody>
            <ModalFooter>
