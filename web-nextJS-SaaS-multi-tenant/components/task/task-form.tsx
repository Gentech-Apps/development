...
export const TaskForm = ({
  ...
  const handleSelectionChange = (name: keyof CreateTask) => (key: SharedSelection) => {
    setFormData((prevState) => ({
      ...prevState,
      [name]: key.currentKey ?? '',
    }));
  ...
  const handleDateChange = (name: keyof CreateTask) => (dateTime: ZonedDateTime) => {
    setFormData((prevState) => ({
      ...prevState,
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    const { reminderError, deadlineError } = validateFormDates({
          ...
          <form onSubmit={handleSubmit}>
            ...
            <ModalBody className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2">
              ...
              <DatePicker
                ...
                defaultValue={
                  task
                    ? (parseZonedDateTime(task.startDateTime + '[Asia/Kolkata]') ??
              ...
              <DatePicker
                ...
                defaultValue={
                  task
                    ? parseZonedDateTime(task.deadline + '[Asia/Kolkata]')
              ...
              <DatePicker
                ...
                defaultValue={
                  task
                    ? parseZonedDateTime(task?.reminder + '[Asia/Kolkata]')
