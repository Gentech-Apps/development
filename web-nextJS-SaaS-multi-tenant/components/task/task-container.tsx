...
import { downloadCSV, filterTasks } from '@/components/task/redux/slices/tasks-slice';
...
import {
  ...
  setPageFilter,
  setStringFilter,
} from '../common/slices/filter-slice';
...
const TaskContainer = () => {
  ...
  return (
    <>
          ...
          <div className="mt-2 mr-2 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <div className="flex flex-col min-w-[180px]">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button isIconOnly variant="bordered" onClick={() => setHideFilters(!hideFilters)}>
                  <FilterIcon />
                </Button>
              </div>
            </div>
                ...
                <div className="flex">
                  <div className="flex flex-col w-[100%]">
                    ...
                    <Select
                      aria-label="sortType"
                      color="secondary"
                      selectedKeys={[filterState.sortType]}
                      id="sortType"
                      name="sortType"
                  ...
                  <div className="flex flex-col">
                    ...
                    <Checkbox
                      isSelected={filterState.overdues}
                  ...
                  <div className="flex flex-col">
                    <p className="font-bold mb-2 pl-2">...</p>
                    <Button
                      variant="bordered"
                      className="p-2"
      ...
      <div className="min-h-[65vh]">{selected === 'cards' ? <RenderCards /> : <RenderTable />}</div>
      {taskState.loading ||
