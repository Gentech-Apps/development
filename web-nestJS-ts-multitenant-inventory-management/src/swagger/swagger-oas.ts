...
export const swaggerDocumentModifications = (document: OpenAPIObject): OpenAPIObject => {
  return {
    ...document,
    components: {
      ...document.components,
...
const filterAndSortSchemas = (schemas?: Record<string, ReferenceObject | SchemaObject>) => {
