...
const { REVIEW, CREATE_ORDER } = CUSTOMERS_PAGE;

const CreatePlainOrderButton = (props) => {
  // const classes = useStyles()
  const { customer, isService } = props;
  ...
  return (
    <React.Fragment>
      ...
      <CreateButton clickHandler={openHandler}>{isService ? REVIEW : CREATE_ORDER}</CreateButton>
    </React.Fragment>
  );
};

export default CreatePlainOrderButton;
